...
def L0Smoothing(image, kappa, _lambda, verbose):
    # Timers
    step_1 = 0.0
    step_2 = 0.0
    step_2_fft = 0.0
...
if __name__ == '__main__':
    # Image File Path
    image_r = "./img/smoothing/flower.jpg"
    image_w = "./res/flower_L0smoothing.png"
    ...
    res = L0Smoothing(image, kappa, _lambda, verbose)

    cv2.imwrite(image_w, res)
